  ...
  return (
    <div className="monitor-app">
      ...
      <div className="monitor-shell">
        ...
        <section className="monitor-section" aria-label="Current health and status">
          <div className="monitor-section-heading">
            <div>
              ...
              <p className="monitor-section-copy">
                Connection health and headline message position are surfaced first for rapid operator scanning.
              </p>
            </div>
        ...
        <section className="monitor-section" aria-label="Comparative throughput">
          <div className="monitor-section-heading">
            <div>
              ...
              <p className="monitor-section-copy">
                Window controls update throughput and analytics together so trend interpretation stays consistent.
              </p>
            </div>
          </div>
        ...
        <section className="monitor-section" aria-label="Reliability trends">
          <div className="monitor-section-heading">
            <div>
        ...
        <section className="monitor-section" aria-label="Historical analytics table">
          <div className="monitor-section-heading">
            <div>
              ...
              <p className="monitor-section-copy">
                Reliability, coverage, disconnect, and recovery signals are presented in a single comparative surface.
              </p>
            </div>
          </div>
