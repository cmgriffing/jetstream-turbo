...
function getChartPalette(): ChartPalette {
  return {
    ...
    streamABg: readCssVar("--monitor-glow-a", "rgba(67, 223, 143, 0.25)"),
    streamB: readCssVar("--monitor-accent-b", "#57b7ff"),
    streamBBg: readCssVar("--monitor-glow-b", "rgba(87, 183, 255, 0.25)"),
    grid: readCssVar("--monitor-border", "#2a4165"),
    ...
    tooltipBg: readCssVar("--monitor-bg-1", "#0a1324"),
  };
}
