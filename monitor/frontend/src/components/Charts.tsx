...
export function UptimeChart24h({ data, streamAName, streamBName }: UptimeChartProps) {
  ...
  return (
    <div className="chart-card bg-[#141414] border border-[#1f1f1f] rounded-3xl p-8 mb-8 transition-colors duration-300 transition-border-color transition-shadow hover:border-[#2a2a2a] hover:shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
