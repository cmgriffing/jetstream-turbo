...
pub struct StreamStats {
    ...
    pub outage_episodes_a: u64,
    pub outage_episodes_b: u64,
    pub outage_episodes_baseline_1: u64,
    pub outage_episodes_baseline_2: u64,
    pub reconnect_attempts_a: u64,
    pub reconnect_attempts_b: u64,
    pub reconnect_attempts_baseline_1: u64,
    pub reconnect_attempts_baseline_2: u64,
    pub idle_episodes_a: u64,
    pub idle_episodes_b: u64,
    pub idle_episodes_baseline_1: u64,
    pub idle_episodes_baseline_2: u64,
    pub transport_recoveries_a: u64,
    pub transport_recoveries_b: u64,
    pub transport_recoveries_baseline_1: u64,
    pub transport_recoveries_baseline_2: u64,
    pub delivery_recoveries_a: u64,
    pub delivery_recoveries_b: u64,
    pub delivery_recoveries_baseline_1: u64,
    pub delivery_recoveries_baseline_2: u64,
    pub delivery_idle_a: bool,
        ...
        tokio::spawn(async move {
            ...
            loop {
                ...
                let stats_snapshot = StreamStats {
                    ...
                    outage_episodes_a: availability_a.outage_episodes,
                    outage_episodes_b: availability_b.outage_episodes,
                    outage_episodes_baseline_1: availability_baseline_1.outage_episodes,
                    outage_episodes_baseline_2: availability_baseline_2.outage_episodes,
                    reconnect_attempts_a: availability_a.reconnect_attempts,
                    reconnect_attempts_b: availability_b.reconnect_attempts,
                    reconnect_attempts_baseline_1: availability_baseline_1.reconnect_attempts,
                    reconnect_attempts_baseline_2: availability_baseline_2.reconnect_attempts,
                    idle_episodes_a: availability_a.idle_episodes,
                    idle_episodes_b: availability_b.idle_episodes,
                    idle_episodes_baseline_1: availability_baseline_1.idle_episodes,
                    idle_episodes_baseline_2: availability_baseline_2.idle_episodes,
                    transport_recoveries_a: availability_a.transport_recoveries,
                    transport_recoveries_b: availability_b.transport_recoveries,
                    transport_recoveries_baseline_1: availability_baseline_1.transport_recoveries,
                    transport_recoveries_baseline_2: availability_baseline_2.transport_recoveries,
                    delivery_recoveries_a: availability_a.delivery_recoveries,
                    delivery_recoveries_b: availability_b.delivery_recoveries,
                    delivery_recoveries_baseline_1: availability_baseline_1.delivery_recoveries,
                    delivery_recoveries_baseline_2: availability_baseline_2.delivery_recoveries,
                    delivery_idle_a: availability_a.delivery_idle,
